    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-3 p-4 bg-white rounded-xl border border-slate-200">
        ...
        <select
          ...
          className="px-3 py-1.5 text-xs font-semibold rounded-lg bg-slate-50 text-slate-600 border border-slate-200 hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
        ...
        <Tooltip id="casos-abiertos" content="Total de casos activos en el sistema">
          ...
          >
            <div className="flex-1 min-w-0">
              ...
              <h3 className="text-xl font-black text-blue-600">{casosAbiertos.length}</h3>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4">
            ...
            {agentes.length > 4 && (
              <button 
                onClick={() => navigate('/app/agentes')}
                className="w-full mt-4 py-2 text-xs font-bold text-slate-500 hover:text-blue-600 border border-slate-100 rounded-lg hover:bg-blue-50 transition-all"
              >
